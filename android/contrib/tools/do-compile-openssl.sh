...
export LDFLAGS="-pie"
export FF_CFLAGS="-I$FF_SYSROOT/usr/include"
export FF_EXTRA_LDFLAGS="-L$FF_SYSROOT/usr/lib"
...
#    ./Configure $FF_CFG_FLAGS -lm  "-L$FF_SYSROOT/usr/lib -I$FF_SYSROOT/usr/include -lm $FF_SYSROOT/usr/lib/libc.a  $FF_SYSROOT/usr/lib/libstdc++.a $FF_SYSROOT/usr/lib/libm.a"
